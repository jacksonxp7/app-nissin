...
export function abastecer_screen() {
  ...
  valoresPercentuaisDashboard(JSON.parse(localStorage.getItem('cadastros'))?.nome, 'abastecimento', sanitize(hoje));
  caixasPercentuaisDashboard(JSON.parse(localStorage.getItem('cadastros'))?.nome, 'abastecimento', sanitize(hoje))
